                ...
                <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-thumb">
                            <img style="height: 100px; width: 100px; border-radius: 100%;" src="/{{ $post->user->profile->avatar }}" alt="Author">
                        </div>
                        ...
                        <div class="blog-details-author-content">
                            ...
                            <div class="socials">
                                ...
                                <a href="{{ $post->user->profile->github }}" target="_blank" class="social__item">
                                    <img src="{{ asset('app/svg/github.svg') }}" alt="github">
                                </a>

                                <a href="{{ $post->user->profile->instagram }}" target="_blank" class="social__item">
                                    <img src="{{ asset('app/svg/instagram.svg') }}" alt="instagram">
                                </a>
                            </div>
                        </div>
                    </div>
